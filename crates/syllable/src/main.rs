...
fn codegen(tone_index: usize) {
    // let mut tone1: Vec<String> = vec![];
    // let mut tone2: Vec<String> = vec![];
    // let mut tone3: Vec<String> = vec![];
    // let mut tone4: Vec<String> = vec![];
    ...
    for py in PINYIN_TABLE.iter() {
        if py != &" " {
            ...
            print!("{:>8}, ", format!("\"{}\"", mark(py, start, end, tone_index)) );
        } else {
            print!("________, ");
        }
