...
// 勘误:
//      1. `o` 是元音，不是韵母。中文和英文维基百科当中的资料误将 `o` 当作了韵母，
//         很可能是来源于 `yo/wo` 音节，但是实际上这两个音节是属于改写后的形式，
//         他们真实的韵母部分应该为 `io -> yo` 和 `uo -> wo` 。
pub static RHYME_TABLE: [&'static str; 67] = [
// |--------------- 单元音韵母 ----------------| |--------- 复元音韵母 ----------| |----------------- 带鼻音韵母 ------------------|
______,    "a", ______,    "e",    "ê",   "er",   "ai",   "ei",   "ao",   "ou",   "an",   "en", ______,  "ang",  "eng", ______,  // 开口呼 ( Group A )
